...
expect 1 $nonFlakeDir/shebang-reject.sh 2>&1 | tee /dev/stderr | grepQuiet -F 'error: unsupported unquoted character in nix shebang: *. Use double backticks to escape?'
